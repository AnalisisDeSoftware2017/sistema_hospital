        ...
        /*	
            if(!this.usuario.equals(this.usuarioValido)){
               ...
               if(!this.contrase?a.equals(this.contrase?aValida))
                   JOptionPane.showMessageDialog(null,"Usuario y contrase?a no son v?lidos. Vuelva a ingresar.");
               else // S?lo el usuario no es v?lido.
                   JOptionPane.showMessageDialog(null, "El usuario no es correcto. Vuelva a ingresar.");
            }else{ // S?lo la contrase?a no es v?lida.
                if(!this.contrase?a.equals(this.contrase?aValida))
                   JOptionPane.showMessageDialog(null,"contrase?a Incorrecta. Vuelva a ingresar.");
                else{ //contrase?a y usuario son v?lidas.

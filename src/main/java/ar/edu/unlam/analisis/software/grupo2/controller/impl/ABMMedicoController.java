...
public class ABMMedicoController extends AbstractABMController<Medico, Long> {
    ...
    @Autowired
    public ABMMedicoController(ListScreenABM<Medico> pantalla, AbstractEntitySaveController<Medico, Long> entitySaveController, AbstractServiceCRUD<Medico, Long> service) {

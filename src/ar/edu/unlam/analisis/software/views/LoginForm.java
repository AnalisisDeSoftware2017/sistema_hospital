...
public class LoginForm extends JFrame {
    ...
    public String getPass(){
       this.contrasenia = ""; //Cadena de String vac?a para luego guardar la contraseña ingresada.
       char [] pass=password.getPassword(); // Obtenemos la contraseña que ingres? el usuario.

...
public class ABMMedicoController extends AbstractABMController<Medico, Long> {
    ...
    @Autowired
    public ABMMedicoController(AbstractListScreenABM<Medico> pantalla, AbstractEntitySaveController<Medico, Long> entitySaveController, AbstractServiceCRUD<Medico, Long> service) {
